...
for i in range (0,10,10):
    url_str = "https://www.tripadvisor.co.kr/Attraction_Review-g298085-d12273530-Reviews-or"
    url_num = str(i)
    url_keyword = "-Da_Nang_Catheral-Da_Nang.html"
...
#    print(review)
    cur.execute("""INSERT INTO review(trip_place,email,username,star_value,review) VALUES (%s,%s,%s,%s,%s);""",('다낭 대성당', 'X', 'unregistered',star_value,review))
