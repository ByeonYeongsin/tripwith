...
for i in range (0,10,10):
    url_str = "https://www.tripadvisor.co.kr/Attraction_Review-g293925-d311103-Reviews-or"
    url_num = str(i)
    url_keyword = "-War_Remnants_Museum-Ho_Chi_Minh_City.html"
...
#    print(star_value)
 ...
 #   print(review)
    cur.execute("""INSERT INTO review(trip_place,email,username,star_value,review) VALUES (%s,%s,%s,%s,%s);""",('전쟁 박물관', 'X', 'unregistered',star_value,review))
