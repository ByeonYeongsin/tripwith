...
for i in range (0,10,10):
    url_str = "https://www.tripadvisor.co.kr/Attraction_Review-g298085-d454980-Reviews-or"
    
    url_num = str(i)
    url_keyword = "-The_Marble_Mountains-Da_Nang.html"
...
#    print(review)
    cur.execute("""INSERT INTO review(trip_place,email,username,star_value,review) VALUES (%s,%s,%s,%s,%s);""",('오행산', 'X', 'unregistered',star_value,review))
