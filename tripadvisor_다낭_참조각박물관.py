...
for i in range (0,10,10):
    url_str = "https://www.tripadvisor.co.kr/Attraction_Review-g298085-d454979-Reviews-or"
    url_num = str(i)
    url_keyword = "-Da_Nang_Museum_of_Cham_Sculpture-Da_Nang.html"
...
for j in range(0,10,1):
    ...
    cur.execute("""INSERT INTO review(trip_place,email,username,star_value,review) VALUES (%s,%s,%s,%s,%s);""",('참 조각 박물관', 'X', 'unregistered',star_value,review))
