...
for i in range (0,10,10):
    url_str = "https://www.tripadvisor.co.kr/Attraction_Review-g293925-d10085046-Reviews-or"
    url_num = str(i)
    url_keyword = "-Tan_Dinh_Church-Ho_Chi_Minh_City.html"
...
#    print(star_value)
 ...
 #   print(review)
    cur.execute("""INSERT INTO review(trip_place,email,username,star_value,review) VALUES (%s,%s,%s,%s,%s);""",('떤딘 성당', 'X', 'unregistered',star_value,review))
