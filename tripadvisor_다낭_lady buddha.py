...
for i in range (0,10,10):
    url_str = "https://www.tripadvisor.co.kr/Attraction_Review-g298085-d5531576-Reviews-or"
    url_num = str(i)
    url_keyword = "-Lady_Buddha-Da_Nang.html"
...
#    print(review)
    cur.execute("""INSERT INTO review(trip_place,email,username,star_value,review) VALUES (%s,%s,%s,%s,%s);""",('영응사', 'X', 'unregistered',star_value,review))
