...
<!-- <section id = "join">
  ...
  <table class="join_section"> 
    <tr>
      <td style="width:30%; background-color:#9CC4DF; color: white;">이메일</td>
      <td style="width:70%; float: right; margin-right: 0px;"><input type="text" name="email" size="30" style="height: 30px;font-size: 15px;margin-top: 10px; "></td>
    </tr>
    <tr>
      <td style="background-color:#9CC4DF; color: white">비밀번호</td>
      <td style="float: right; margin-right: 0px;"><input type="password" name="password" size="30" style="height: 45px;font-size: 20px;margin-top: 10px;"></td>
    </tr>
    <tr>
      <td style="background-color:#9CC4DF; color: white">이름</td>
      <td style="float: right;margin-right: 0px;"><input type="text" name="username" size="30" style="height: 45px;font-size: 20px;margin-top: 10px;"></td>
    </tr>
    <tr>
      <td style="background-color:#9CC4DF; color: white">성별</td>
      <td style="float: left;">
        &nbsp
      <input type="radio" name="chk_info" value="woman" style="width:20px;height:30px;border:1px;">여자
        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <input type="radio" name="chk_info" value="man" style="width:20px;height:30px;border:1px;">남자
      </td>
    </tr>
    <tr>
      <td style="background-color:#9CC4DF; color: white">나이</td>
      <td style="float: right; margin-right: 0px;"><input type="text" name="age" size="30" style="height: 45px;font-size: 20px;margin-top: 10px;"></td>
    </tr>
  </table>
...
<center>
  ...
  <div class="login_box">
        <form method="POST" action="Join_back.php">
          ...
          <br><div style = "text-align: left;"><h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회원가입</h1></div>
          ...
          <div style="position:relative;" class="password" >
            <label for="ex4-pw-input" class="email_b1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;비밀번호</label>
            <input type="password" class="email_b2"  value="" id="ex4-pw-input" name="password" />
          </div>
          <div style="position:relative;" class="password" >
            <label for="ex4-email-input" class="email_b1">이름</label>
            <input type="text" class="email_b2"  value="" id="ex4-email-input" name="username" />
          </div>
          <div style="position:relative;">
            <p style = "line-height: 1.3; text-align: left; margin-left: 55px"><strong>성별</strong>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="chk_info" value="woman" style="width:20px;height:20px;border:1px;">여자
            &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="chk_info" value="man" style="width:20px;height:20px;border:1px;">남자 </p>
          </div>
          <div style="position:relative;" class="password" >
            <label for="ex4-email-input" class="email_b1">나이</label>
            <input type="text" class="email_b2"  value="" id="ex4-email-input" name="age" />
          </div>
          <br>
