...
for i in range (0,10,10):
    url_str = "https://www.tripadvisor.co.kr/Attraction_Review-g293924-d311066-Reviews-or"
    url_num = str(i)
    url_keyword = "-Ho_Chi_Minh_Museum-Hanoi.html"
...
#    print(star_value)
 ...
 #   print(review)
    cur.execute("""INSERT INTO review(trip_place,email,username,star_value,review) VALUES (%s,%s,%s,%s,%s);""",('호치민 박물관', 'X', 'unregistered',star_value,review))
