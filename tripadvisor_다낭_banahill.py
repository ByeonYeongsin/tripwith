...
for i in range (0,10,10):
    url_str = "https://www.tripadvisor.com/Attraction_Review-g298085-d2255351-Reviews-or"
    url_num = str(i)
    url_keyword = "-Ba_Na_Hills-Da_Nang.html"
...
#    print(review)
    cur.execute("""INSERT INTO review(trip_place,email,username,star_value,review) VALUES (%s,%s,%s,%s,%s);""",('바나 힐', 'X', 'unregistered',star_value,review))
